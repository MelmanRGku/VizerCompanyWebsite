                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <?php
                        ...
                        <a href="http://ec2-52-35-129-61.us-west-2.compute.amazonaws.com/VizerCompanyWebsite/DesktopViewer.html" class="btn btn-transparent" id="button'.$counter.'" value="'.$listing["ListingID"]["S"].'" onclick="retrieveListingID(this)">Desktop Touring</a></h6>';
                        echo "</div>";
                      ?>
                    </div>
                  </div>
